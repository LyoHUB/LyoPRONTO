...
# Get all the inputs that are defined into a config dictionary
config = {}
loc = locals()
...
save_configuration_legacy(config, current_time)
    
########################################################

################### Execute  ##########################

output_data = execute_simulation(config)
...
# Write data to files
save_csv(output_data, config, current_time)

# Plot data and save figures

generate_visualizations(output_data, config, current_time)