...
from lyopronto.functions import crystallization_time_FUN, lumped_cap_Tpr_ice, lumped_cap_Tpr_sol
...
class TestFreezingFuncs:
    ...
    def test_lumped_cap(self, freezing_params):
        ...
        newT1 = lumped_cap_Tpr_sol(dt, Tpr0, vial['Vfill'], h_freezing, vial['Av'], Tsh, Tsh0, Tshelf['ramp_rate'])
        newT2 = lumped_cap_Tpr_ice(dt, Tpr0, vial['Vfill'], h_freezing, vial['Av'], Tsh, Tsh0, Tshelf['ramp_rate'])
        assert Tpr0 > newT1
        assert Tpr0 > newT2
        assert newT1 > Tsh
        assert newT2 > Tsh
...
class TestFreezingEdgeCases:
    ...
    def test_freezing_below_nucleation(self, ):
