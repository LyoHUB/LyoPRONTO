...
def run_optimizer_example():
    ...
    product = {
        ...
        'T_pr_crit': -25.0   # Critical product temperature (°C)
    }
    
    # Heat transfer parameters
    ht = {
        'KC': 2.75e-4,   # Contact coefficient (cal/s/K/cm²)
    ...
    Tshelf = {
        'min': -45.0,    # Minimum shelf temperature (°C)
        'max': -5.0,     # Maximum shelf temperature (°C)
    }
